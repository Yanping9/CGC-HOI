...
def base_detector_args():
    ...
    parser.add_argument('--num_ho_layers', default=1, type=int)
    ...
    parser.add_argument('--data-root', default='./vcoco')
    parser.add_argument('--output-dir', default='output/vcoco_pl_test')
    parser.add_argument('--pretrained', default='checkpoints/detr-r50-vcoco.pth', help='Path to a pretrained detector')
