...
class AveragePrecisionMeter:
    ...
    @staticmethod
    def compute_per_class_ap_with_interpolation(tuple_: Tuple[Tensor, Tensor], eps: float) -> Tensor:
        """
        Arguments:
            tuple_(Tuple[Tensor, Tensor]): precision and recall
        Returns:
    ...
    @staticmethod
    def compute_per_class_ap_with_11_point_interpolation(tuple_: Tuple[Tensor, Tensor], eps:float) -> Tensor:
        """
        Arguments:
            tuple_(Tuple[Tensor, Tensor]): precision and recall
        Returns:
